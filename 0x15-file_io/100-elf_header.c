...
/**
 * print_class - Prints out class of an ELF header.
 *
...
/**
 * print_abi - Prints out ABI version of an ELF header.
...
/**
 * print_type - Prints out type of an ELF header.
 * @e_type:  ELF type.
...
/**
 * close_elf -  For closing ELF file.
 * @elf: file descriptor
 *
...
/**
 * main - To display information contained in the
 ...
 * Return: 0
 *
 * Description: If file is not ELF File or if
